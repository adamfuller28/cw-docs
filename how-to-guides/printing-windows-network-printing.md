...
1. If your printer is not showing use these instructions to set it up Printer Set up.
2. To test that the printer is working, please press Print Test Page

![](../.gitbook/assets/untitled-3%20%281%29.png)

1. If the test page does not print. Then please connect and install the printer correctly. Please see : Printer Set up.
2. Open the PushPrinter for Windows program application
3. Go to the 'settings' cog and select the default or Knock Knock Booze provider profile from the dropdown list.
