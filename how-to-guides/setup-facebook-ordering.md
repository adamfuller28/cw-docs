...
Choose "Page Tab". You will now need to fill in your store URL under "Secure Page Tab URL" and what you want to call your page tab under "Page Tab Name". Your store URL can either be your knockknockbooze subdomain such as "[https://yourdomain.knockknockbooze.com](https://yourdomain.knockknockbooze.com)" or your custom domain name if setup

![](../.gitbook/assets/fb-order-online-tab.png)
